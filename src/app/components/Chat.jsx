          ...
          <div className="rounded-2xl bg-white border border-gray-200 shadow-sm p-6">
            ...
            <div className="space-y-6">
              <div className="max-w-md">
                <div className="rounded-full border border-gray-400 bg-blue-100 px-4 py-3 text-black shadow-sm">
                  Hi, ada yang bisa saya bantu?
                </div>
              </div>

              <div className="flex justify-end">
                <div className="max-w-md rounded-2xl border border-gray-400 bg-white px-4 py-3 text-black shadow-sm">
                  Hai Kak, saya mau konsultasi soal perkembangan bicara anak
                  saya. Dia usia 3 tahun tapi masih sering cuma mengeluarkan 1–2
                  kata, dan kadang hanya menunjuk kalau mau sesuatu. Apakah itu
                  normal?
                </div>
              </div>
              ...
              <div className="flex justify-end">
                <div className="max-w-md rounded-full border border-gray-400 bg-white px-4 py-3 text-black shadow-sm">
                  Boleh kak, silakan.
                </div>
              </div>

              <div className="max-w-lg rounded-2xl border border-gray-400 bg-blue-100 px-4 py-3 text-black shadow-sm">
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Apakah anak Ibu sudah bisa meniru kata sederhana seperti
                    “ma”, “pa”, atau nama benda?
                  </li>
                  <li>Bagaimana responsnya saat dipanggil nama?</li>
                  <li>
                    Apakah dia memahami instruksi sederhana, seperti “ambil
                    bola” atau “duduk dulu”?
                  </li>
                </ul>
              </div>
            </div>
