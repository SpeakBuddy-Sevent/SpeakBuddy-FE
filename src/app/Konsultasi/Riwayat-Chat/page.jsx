              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-600 truncate mt-2">
                    InsyaAllah, Bu. Yang penting konsisten. Banyak anak speech
                    delay yang akhirnya bisa mengejar ketertinggalannya dengan
                    latihan rutin. Kita kerjakan bersama ya 😊
                  </p>
                </div>
              </div>
